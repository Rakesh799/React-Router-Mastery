...
const Contact = () => {
    return (
        <>
            <div>
                <div className="w-1/5 bg-[#F3E5F5] mx-auto text-center rounded-lg">
                    <h1 className='text-3xl font-bold p-3 my-4'>Contact us</h1>
                </div>
                <div className='w-3/4 h-96 mx-auto flex justify-between items-center gap-12'>
                    ...
                    <div className='w-1/2 shadow-2xl rounded-lg p-4'>
